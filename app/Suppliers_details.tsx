...
export default function SuppliersDetails(){
    return(
        <View>
            ...
            <View style={styles.inputTextContainer}><TextInput style={styles.InputSupplierDetails}placeholder="Contact no*."></TextInput></View>
            <View style={styles.inputTextContainer}><TextInput style={styles.InputSupplierDetails}placeholder="Email Id*"></TextInput></View>
            <View style={styles.inputTextContainer}><TextInput style={styles.InputSupplierDetails}placeholder="GSTIN no.*"></TextInput></View>
            <View style={styles.inputTextContainer}><TextInput style={styles.InputSupplierDetails}placeholder="Outstanding Amount*"></TextInput></View>
